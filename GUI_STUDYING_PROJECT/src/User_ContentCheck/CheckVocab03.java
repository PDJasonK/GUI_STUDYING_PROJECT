...
//-------------------------
	...
	public CheckVocab03() {
		...
		// -------------------
		/*
		 * PContent1 = new JLabel("泥ル쾲吏�? ?��몃떒�쓽 �빐�꽍?���?", JLabel.LEFT);
		 * PContent1.setBounds(15, 240, 500, 500); PContent2 = new
		 * JLabel("�몢踰덉?�� ?��몃떒�쓽 �빐�꽍?���?", JLabel.LEFT); PContent2.setBounds(15, 380, 500,
		 * 500); PContent3 = new JLabel("�꽭踰덉?�� 泥ル쾲吏�? ?��몃떒�쓽 �빐�꽍?���? ", JLabel.LEFT);
