...
public class ReadingMain1 extends WindowAdapter implements ActionListener {
	...
	public ReadingMain1() {
		...
		title = new JLabel("첫번 번째 지문");
		title.setBounds(30, 0, 800, 90);

		review1.setLayout(null);
		review1.setBounds(30, 50, 800, 350);

		PContent1 = new JLabel("[Write First] 첫번째 지문 해석문 적기 - [입력 후 Submit 버튼으로 해당내용을 전송해주세요.]", JLabel.LEFT);
		...
		btn0 = new JButton("토익 메인 선택 화면으로 돌아가기");
		btn0.setLayout(null);
		...
		btn0.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ToeicOptions AP = new ToeicOptions();
